...
ValAccuracy = []
learning_rate_policy = [[5, learing_rate],
                        [7, learing_rate/10],
                        [8, learing_rate/100],
                        [10, learing_rate/1000]
                        ]
get_learing_rate = MultiStageLearningRatePolicy(learning_rate_policy)


model_path = './training_models/p_se_resnext101_32x4d_exp5.pt'
save_path = './p_net_exp6.pt'
best_path = './training_models/p_se_resnext101_32x4d_exp6.pt'
log_dir = './logs/p_se_resnext101_32x4d_exp6'
...
optimizer = optim.SGD(net.parameters(), lr = learing_rate, weight_decay = weight_decay)
